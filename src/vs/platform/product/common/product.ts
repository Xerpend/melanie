...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			version: '1.104.0-dev',
			nameShort: 'Melanie Dev',
			nameLong: 'Melanie Dev',
			applicationName: 'melanie',
			dataFolderName: '.melanie-oss',
			urlProtocol: 'melanie',
			reportIssueUrl: 'https://github.com/Xerpend/melanie/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/Xerpend/melanie/blob/main/LICENSE',
			serverLicenseUrl: 'https://github.com/Xerpend/melanie/blob/main/LICENSE'
		});
	}
}
